                	...
                	<div class="row">
                		<div class="col-md-6">
			                <div class="panel panel-info">
			                    <div class="panel-heading">
			                        <h4 class="panel-title">Get Help Members</h4>
			                    </div>
			                    <div class="panel-body">
                		...
                		<div class="col-md-6">
			               	<div class="panel panel-info">
			                    <div class="panel-heading">
			                        <h4 class="panel-title">Provide Help Members</h4>
			                    </div>
			                    <div class="panel-body">
		            ...
		            <div class="row">
		            	...
		            	<div class="col-md-3">
			            	<form name="MatchingForm">
			            		{{csrf_field()}}
			            		<button type="button" id="MatchUsrM" class="btn btn-primary">Match Manually</button>
			            	</form>
			            </div>
